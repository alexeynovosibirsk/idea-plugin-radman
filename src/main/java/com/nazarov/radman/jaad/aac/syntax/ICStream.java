...
import com.nazarov.radman.jaad.aac.ChannelConfiguration;
import com.nazarov.radman.jaad.aac.DecoderConfig;
import com.nazarov.radman.jaad.aac.error.RVLC;
import com.nazarov.radman.jaad.aac.gain.GainControl;
import com.nazarov.radman.jaad.aac.huffman.HCB;
import com.nazarov.radman.jaad.aac.huffman.Huffman;
import com.nazarov.radman.jaad.aac.tools.TNS;

import java.util.Arrays;
import java.util.logging.Level;

//TODO: apply pulse data
public class ICStream implements Constants, HCB, ScaleFactorTable, com.nazarov.radman.jaad.aac.syntax.IQTable {
	...
	//always needed
	private final com.nazarov.radman.jaad.aac.syntax.ICSInfo info;
	...
	public ICStream(int frameLength) {
		...
		info = new com.nazarov.radman.jaad.aac.syntax.ICSInfo(frameLength);
