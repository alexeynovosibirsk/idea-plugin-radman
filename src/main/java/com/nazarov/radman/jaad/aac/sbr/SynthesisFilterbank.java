...
class SynthesisFilterbank implements com.nazarov.radman.jaad.aac.sbr.FilterbankTable {
	...
	void sbr_qmf_synthesis_32(com.nazarov.radman.jaad.aac.sbr.SBR sbr, float[][][] X,
							  float[] output) {
	...
	void sbr_qmf_synthesis_64(SBR sbr, float[][][] X,
		...
		for(l = 0; l<sbr.numTimeSlotsRate; l++) {
			...
			com.nazarov.radman.jaad.aac.sbr.DCT.dct4_kernel(in_real1, in_imag1, out_real1, out_imag1);
			com.nazarov.radman.jaad.aac.sbr.DCT.dct4_kernel(in_real2, in_imag2, out_real2, out_imag2);
