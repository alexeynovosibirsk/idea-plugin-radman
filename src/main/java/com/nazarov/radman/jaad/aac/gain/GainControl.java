package com.nazarov.radman.jaad.aac.gain;

import com.nazarov.radman.jaad.aac.AACException;
import com.nazarov.radman.jaad.aac.syntax.BitStream;
import com.nazarov.radman.jaad.aac.syntax.ICSInfo.WindowSequence;

import java.util.Arrays;

public class GainControl implements com.nazarov.radman.jaad.aac.gain.GCConstants {

	private final int frameLen, lbLong, lbShort;
	private final com.nazarov.radman.jaad.aac.gain.IMDCT imdct;
	private final com.nazarov.radman.jaad.aac.gain.IPQF ipqf;
	...
	public GainControl(int frameLen) {
		...
		lbShort = lbLong/8;
		imdct = new com.nazarov.radman.jaad.aac.gain.IMDCT(frameLen);
		ipqf = new com.nazarov.radman.jaad.aac.gain.IPQF();
		levelPrev = new int[0][][];
