...
class AnalysisFilterbank implements com.nazarov.radman.jaad.aac.sbr.FilterbankTable {
	...
	void sbr_qmf_analysis_32(SBR sbr, float[] input,
		...
		for(l = 0; l<sbr.numTimeSlotsRate; l++) {
			...
			com.nazarov.radman.jaad.aac.sbr.DCT.dct4_kernel(in_real, in_imag, out_real, out_imag);
