...
class HFAdjustment implements com.nazarov.radman.jaad.aac.sbr.Constants, com.nazarov.radman.jaad.aac.sbr.NoiseTable {
	...
	public static int hf_adjustment(com.nazarov.radman.jaad.aac.sbr.SBR sbr, float[][][] Xsbr, int ch) {
	...
	private static int get_S_mapped(com.nazarov.radman.jaad.aac.sbr.SBR sbr, int ch, int l, int current_band) {
	...
	private static int estimate_current_envelope(com.nazarov.radman.jaad.aac.sbr.SBR sbr, HFAdjustment adj,
												 float[][][] Xsbr, int ch) {
	...
	private static void hf_assembly(com.nazarov.radman.jaad.aac.sbr.SBR sbr, HFAdjustment adj,
									float[][][] Xsbr, int ch) {
