...
import com.nazarov.radman.jaad.spi.javasound.CircularBuffer.Trigger;
...
abstract class AsynchronousAudioInputStream extends AudioInputStream implements Trigger {
	...
	protected final com.nazarov.radman.jaad.spi.javasound.CircularBuffer buffer;

	AsynchronousAudioInputStream(InputStream in, AudioFormat format, long length) throws IOException {
		super(in, format, length);
		buffer = new com.nazarov.radman.jaad.spi.javasound.CircularBuffer(this);
	}
