...
import com.nazarov.radman.jaad.mp4.api.Track.Codec;
import com.nazarov.radman.jaad.mp4.api.drm.ITunesProtection;
...
public abstract class Protection {
	...
	protected Protection(Box sinf) {
		...
		if(!(c = com.nazarov.radman.jaad.mp4.api.AudioTrack.AudioCodec.forType(type)).equals(AudioTrack.AudioCodec.UNKNOWN_AUDIO_CODEC)) originalFormat = c;
