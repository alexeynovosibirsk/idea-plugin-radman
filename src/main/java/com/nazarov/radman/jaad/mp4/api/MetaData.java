...
public class MetaData {
	...
	public static class Field<T> {
		...
		public static final Field<List<com.nazarov.radman.jaad.mp4.api.Artwork>> COVER_ARTWORKS = new Field<List<com.nazarov.radman.jaad.mp4.api.Artwork>>("Cover Artworks");
	...
	private void parseITunesMetaData(Box ilst) {
		...
		for(Box box : boxes) {
			...
			if(l==BoxTypes.ARTIST_NAME_BOX) put(Field.ARTIST, data.getText());
				...
				final com.nazarov.radman.jaad.mp4.api.Artwork aw = new com.nazarov.radman.jaad.mp4.api.Artwork(com.nazarov.radman.jaad.mp4.api.Artwork.Type.forDataType(data.getDataType()), data.getData());
				if(contents.containsKey(Field.COVER_ARTWORKS)) get(Field.COVER_ARTWORKS).add(aw);
				else {
					final List<com.nazarov.radman.jaad.mp4.api.Artwork> list = new ArrayList<Artwork>();
					list.add(aw);
	...
	private void parseID3(ID3TagBox box) {
		try {
			...
			com.nazarov.radman.jaad.mp4.api.ID3Tag tag = new com.nazarov.radman.jaad.mp4.api.ID3Tag(in);
			int[] num;
			for(com.nazarov.radman.jaad.mp4.api.ID3Frame frame : tag.getFrames()) {
				switch(frame.getID()) {
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.TITLE:
						put(Field.TITLE, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.ALBUM_TITLE:
						put(Field.ALBUM, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.TRACK_NUMBER:
						num = frame.getNumbers();
						put(Field.TRACK_NUMBER, num[0]);
						if(num.length>1) put(Field.TOTAL_TRACKS, num[1]);
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.ARTIST:
						put(Field.ARTIST, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.COMPOSER:
						put(Field.COMPOSER, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.BEATS_PER_MINUTE:
						put(Field.TEMPO, frame.getNumber());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.LENGTH:
						put(Field.LENGTH_IN_MILLISECONDS, frame.getNumber());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.LANGUAGES:
						put(Field.LANGUAGE, frame.getLocale());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.COPYRIGHT_MESSAGE:
						put(Field.COPYRIGHT, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.PUBLISHER:
						put(Field.PUBLISHER, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.INTERNET_RADIO_STATION_NAME:
						put(Field.INTERNET_RADIO_STATION, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.ENCODING_TIME:
						put(Field.ENCODING_DATE, frame.getDate());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.RELEASE_TIME:
						put(Field.RELEASE_DATE, frame.getDate());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.ENCODING_TOOLS_AND_SETTINGS:
						put(Field.ENCODER_TOOL, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.PERFORMER_SORT_ORDER:
						put(Field.ARTIST_SORT_TEXT, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.TITLE_SORT_ORDER:
						put(Field.TITLE_SORT_TEXT, frame.getEncodedText());
						break;
					case com.nazarov.radman.jaad.mp4.api.ID3Frame.ALBUM_SORT_ORDER:
