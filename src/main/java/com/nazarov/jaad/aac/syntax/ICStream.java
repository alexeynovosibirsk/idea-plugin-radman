...
import com.nazarov.jaad.aac.ChannelConfiguration;
import com.nazarov.jaad.aac.DecoderConfig;
import com.nazarov.jaad.aac.error.RVLC;
import com.nazarov.jaad.aac.gain.GainControl;
import com.nazarov.jaad.aac.huffman.HCB;
import com.nazarov.jaad.aac.huffman.Huffman;
import com.nazarov.jaad.aac.tools.TNS;

import java.util.Arrays;
import java.util.logging.Level;

//TODO: apply pulse data
public class ICStream implements Constants, HCB, ScaleFactorTable, com.nazarov.jaad.aac.syntax.IQTable {
	...
	//always needed
	private final com.nazarov.jaad.aac.syntax.ICSInfo info;
	...
	public ICStream(int frameLength) {
		...
		info = new com.nazarov.jaad.aac.syntax.ICSInfo(frameLength);
