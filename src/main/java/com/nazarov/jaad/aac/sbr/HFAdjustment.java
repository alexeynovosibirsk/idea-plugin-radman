...
class HFAdjustment implements com.nazarov.jaad.aac.sbr.Constants, com.nazarov.jaad.aac.sbr.NoiseTable {
	...
	public static int hf_adjustment(com.nazarov.jaad.aac.sbr.SBR sbr, float[][][] Xsbr, int ch) {
	...
	private static int get_S_mapped(com.nazarov.jaad.aac.sbr.SBR sbr, int ch, int l, int current_band) {
	...
	private static int estimate_current_envelope(com.nazarov.jaad.aac.sbr.SBR sbr, HFAdjustment adj,
                                                 float[][][] Xsbr, int ch) {
	...
	private static void hf_assembly(com.nazarov.jaad.aac.sbr.SBR sbr, HFAdjustment adj,
                                    float[][][] Xsbr, int ch) {
