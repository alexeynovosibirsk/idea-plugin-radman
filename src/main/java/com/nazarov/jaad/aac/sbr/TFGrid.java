...
class TFGrid implements Constants {
	...
	public static int envelope_time_border_vector(com.nazarov.jaad.aac.sbr.SBR sbr, int ch) {
		int l, border, temp;
	...
	public static void noise_floor_time_border_vector(com.nazarov.jaad.aac.sbr.SBR sbr, int ch) {
