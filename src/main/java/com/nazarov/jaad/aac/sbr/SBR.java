package com.nazarov.jaad.aac.sbr;

import com.nazarov.jaad.aac.AACException;
import com.nazarov.jaad.aac.SampleFrequency;
import com.nazarov.jaad.aac.ps.PS;
import com.nazarov.jaad.aac.syntax.BitStream;

import java.util.Arrays;

public class SBR implements Constants, com.nazarov.jaad.aac.syntax.Constants, HuffmanTables {
	...
	int calc_sbr_tables(int start_freq, int stop_freq,
		...
		this.k0 = com.nazarov.jaad.aac.sbr.FBT.qmf_start_channel(start_freq, samplerate_mode, this.sample_rate);
		k2 = com.nazarov.jaad.aac.sbr.FBT.qmf_stop_channel(stop_freq, this.sample_rate, this.k0);
		...
		if(freq_scale==0) {
			result += com.nazarov.jaad.aac.sbr.FBT.master_frequency_table_fs0(this, this.k0, k2, alter_scale);
		}
		else {
			result += com.nazarov.jaad.aac.sbr.FBT.master_frequency_table(this, this.k0, k2, freq_scale, alter_scale);
		}
		result += com.nazarov.jaad.aac.sbr.FBT.derived_frequency_table(this, xover_band, k2);
