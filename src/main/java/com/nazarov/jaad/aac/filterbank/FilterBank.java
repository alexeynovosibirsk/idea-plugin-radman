package com.nazarov.jaad.aac.filterbank;
...
public class FilterBank implements Constants, SineWindows, KBDWindows {
	...
	private final com.nazarov.jaad.aac.filterbank.MDCT mdctShort, mdctLong;
	...
	public FilterBank(boolean smallFrames, int channels) throws AACException {
		...
		mdctShort = new com.nazarov.jaad.aac.filterbank.MDCT(shortLen*2);
		mdctLong = new com.nazarov.jaad.aac.filterbank.MDCT(length*2);
