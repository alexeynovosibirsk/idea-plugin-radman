...
import com.nazarov.jaad.mp4.boxes.impl.*;
import com.nazarov.jaad.mp4.boxes.impl.ESDBox;
import com.nazarov.jaad.mp4.boxes.impl.drm.FairPlayDataBox;
import com.nazarov.jaad.mp4.boxes.impl.fd.*;
import com.nazarov.jaad.mp4.boxes.impl.meta.*;
import com.nazarov.jaad.mp4.boxes.impl.oma.*;
import com.nazarov.jaad.mp4.boxes.impl.sampleentries.*;
import com.nazarov.jaad.mp4.boxes.impl.sampleentries.codec.*;
...
public class BoxFactory implements BoxTypes {
	...
	private static final Map<Long, Class<? extends com.nazarov.jaad.mp4.boxes.BoxImpl>> BOX_CLASSES = new HashMap<Long, Class<? extends com.nazarov.jaad.mp4.boxes.BoxImpl>>();
	private static final Map<Long, Class<? extends com.nazarov.jaad.mp4.boxes.BoxImpl>[]> BOX_MULTIPLE_CLASSES = new HashMap<Long, Class<? extends com.nazarov.jaad.mp4.boxes.BoxImpl>[]>();
	private static final Map<Long, String[]> PARAMETER = new HashMap<Long, String[]>();

	static {
		//classes
		BOX_CLASSES.put(ADDITIONAL_METADATA_CONTAINER_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(DATA_INFORMATION_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(EDIT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(MEDIA_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(MEDIA_DATA_BOX, MediaDataBox.class);
		BOX_CLASSES.put(MEDIA_HEADER_BOX, MediaHeaderBox.class);
		BOX_CLASSES.put(MEDIA_INFORMATION_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(META_BOX, MetaBox.class);
		BOX_CLASSES.put(META_BOX_RELATION_BOX, MetaBoxRelationBox.class);
		BOX_CLASSES.put(MOVIE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(MOVIE_EXTENDS_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(MOVIE_EXTENDS_HEADER_BOX, MovieExtendsHeaderBox.class);
		BOX_CLASSES.put(MOVIE_FRAGMENT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(MOVIE_FRAGMENT_HEADER_BOX, MovieFragmentHeaderBox.class);
		BOX_CLASSES.put(MOVIE_FRAGMENT_RANDOM_ACCESS_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(NULL_MEDIA_HEADER_BOX, com.nazarov.jaad.mp4.boxes.FullBox.class);
		BOX_CLASSES.put(ORIGINAL_FORMAT_BOX, OriginalFormatBox.class);
		BOX_CLASSES.put(PADDING_BIT_BOX, PaddingBitBox.class);
		BOX_CLASSES.put(PARTITION_ENTRY, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(PROTECTION_SCHEME_INFORMATION_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(SAMPLE_TABLE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(SCHEME_INFORMATION_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(TRACK_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TRACK_EXTENDS_BOX, TrackExtendsBox.class);
		BOX_CLASSES.put(TRACK_FRAGMENT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(USER_DATA_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(ITUNES_META_LIST_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(CUSTOM_ITUNES_METADATA_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(ALBUM_ARTIST_NAME_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ALBUM_ARTIST_SORT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ALBUM_NAME_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ALBUM_SORT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ARTIST_NAME_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ARTIST_SORT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(CATEGORY_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(COMMENTS_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(COMPILATION_PART_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(COMPOSER_NAME_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(COMPOSER_SORT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(COVER_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(CUSTOM_GENRE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(DESCRIPTION_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(DISK_NUMBER_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ENCODER_NAME_BOX, EncoderBox.class);
		BOX_CLASSES.put(ENCODER_TOOL_BOX, EncoderBox.class);
		BOX_CLASSES.put(EPISODE_GLOBAL_UNIQUE_ID_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(GAPLESS_PLAYBACK_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(GENRE_BOX, GenreBox.class);
		BOX_CLASSES.put(GROUPING_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(HD_VIDEO_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ITUNES_PURCHASE_ACCOUNT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ITUNES_ACCOUNT_TYPE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ITUNES_CATALOGUE_ID_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(ITUNES_COUNTRY_CODE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(KEYWORD_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(LONG_DESCRIPTION_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(LYRICS_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(META_TYPE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(PODCAST_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(PODCAST_URL_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(PURCHASE_DATE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(RATING_BOX, RatingBox.class);
		BOX_CLASSES.put(RELEASE_DATE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(REQUIREMENT_BOX, RequirementBox.class);
		BOX_CLASSES.put(TEMPO_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TRACK_NAME_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TRACK_NUMBER_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TRACK_SORT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TV_EPISODE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TV_EPISODE_NUMBER_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TV_NETWORK_NAME_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TV_SEASON_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TV_SHOW_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(TV_SHOW_SORT_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(GOOGLE_HOST_HEADER_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(GOOGLE_PING_MESSAGE_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(GOOGLE_PING_URL_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(GOOGLE_SOURCE_DATA_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(GOOGLE_START_TIME_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(GOOGLE_TRACK_DURATION_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		...
		BOX_CLASSES.put(OMA_DRM_CONTAINER_BOX, com.nazarov.jaad.mp4.boxes.FullBox.class);
		...
		BOX_CLASSES.put(OMA_MUTABLE_DRM_INFORMATION_BOX, com.nazarov.jaad.mp4.boxes.BoxImpl.class);
		BOX_CLASSES.put(OMA_KEY_MANAGEMENT_BOX, com.nazarov.jaad.mp4.boxes.FullBox.class);
	...
	public static com.nazarov.jaad.mp4.boxes.Box parseBox(com.nazarov.jaad.mp4.boxes.Box parent, MP4InputStream in) throws IOException {
		...
		final com.nazarov.jaad.mp4.boxes.BoxImpl box = forType(type, in.getOffset());
		box.setParams(parent, size, type, offset);
		box.decode(in);

		//if box doesn't contain data it only contains children
		final Class<?> cl = box.getClass();
		if(cl== com.nazarov.jaad.mp4.boxes.BoxImpl.class||cl== FullBox.class) box.readChildren(in);
	...
	//TODO: remove usages
	public static Box parseBox(MP4InputStream in, Class<? extends com.nazarov.jaad.mp4.boxes.BoxImpl> boxClass) throws IOException {
		final long offset = in.getOffset();
		...
		com.nazarov.jaad.mp4.boxes.BoxImpl box = null;
		try {
	...
	private static com.nazarov.jaad.mp4.boxes.BoxImpl forType(long type, long offset) {
		com.nazarov.jaad.mp4.boxes.BoxImpl box = null;

		final Long l = Long.valueOf(type);
		if(BOX_CLASSES.containsKey(l)) {
			Class<? extends com.nazarov.jaad.mp4.boxes.BoxImpl> cl = BOX_CLASSES.get(l);
