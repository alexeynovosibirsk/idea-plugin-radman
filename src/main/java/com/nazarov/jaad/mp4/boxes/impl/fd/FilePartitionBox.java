package com.nazarov.jaad.mp4.boxes.impl.fd;
...
public class FilePartitionBox extends FullBox {
	...
	public void decode(MP4InputStream in) throws IOException {
		...
		schemeSpecificInfo = new String(com.nazarov.jaad.mp4.boxes.impl.fd.Base64Decoder.decode(in.readTerminated((int) getLeft(in), 0)));
