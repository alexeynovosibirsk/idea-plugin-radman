...
import com.nazarov.jaad.mp4.api.Track.Codec;
import com.nazarov.jaad.mp4.api.drm.ITunesProtection;
import com.nazarov.jaad.mp4.boxes.Box;
import com.nazarov.jaad.mp4.boxes.BoxTypes;
import com.nazarov.jaad.mp4.boxes.impl.OriginalFormatBox;
import com.nazarov.jaad.mp4.boxes.impl.SchemeTypeBox;
...
public abstract class Protection {
	...
	protected Protection(Box sinf) {
		...
		if(!(c = com.nazarov.jaad.mp4.api.AudioTrack.AudioCodec.forType(type)).equals(AudioTrack.AudioCodec.UNKNOWN_AUDIO_CODEC)) originalFormat = c;
